...
export function CountdownHeader({ onComplete }: CountdownHeaderProps) {
  ...
  return (
    <>
      ...
      >
        <motion.div
          className="relative flex items-center justify-center text-4xl md:text-5xl font-light tracking-tight text-white"
          style={{
            textShadow: isShattered ? '0 0 20px rgba(255, 255, 255, 0.8), 0 0 40px rgba(255, 0, 0, 0.5)' : '0 2px 10px rgba(0, 0, 0, 0.5)',
            filter: isShattered ? 'drop-shadow(0 0 10px rgba(255, 255, 255, 0.8))' : 'none'
          }}
