      ...
      {isOpen && (
        ...
        >
          <motion.button
            ...
            className="fixed top-8 right-8 z-[210] p-3 text-white/70 hover:text-white transition-colors"
          ...
          <motion.div
            className="fixed top-8 left-8 z-[210] text-white/70 text-sm tracking-wider"
            initial={{ opacity: 0, y: -20 }}
            animate={{ opacity: 1, y: 0 }}
            transition={{ delay: 0.2 }}
          >
          ...
          <motion.div
            ...
            className="fixed bottom-8 left-1/2 z-[210] -translate-x-1/2 text-white/40 text-xs tracking-widest uppercase"
          >
