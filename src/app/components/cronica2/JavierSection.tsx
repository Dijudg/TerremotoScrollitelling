...
const javierSections = [
  {
    text: "Segundos antes de las 18:58, el vehículo de la familia Pincay se paró en la intersección de las calles Pedro Gual y Chile, en Portoviejo. Esperaba el cambio a verde, pero este caprichosamente no llegó. En contraste, un fuerte sacudón estremeció la ciudad costera y devastó el centro de comercio más importante de la ciudad. ",
  ...
  {
    text: "Las paredes y las ventanas mostraron su fragilidad ante el devastador sismo y, a la par, se convirtieron en “armas letales”. Chocaban sin piedad sobre carros y en contra de decenas de personas, a las que la oscuridad les llegaba casi de inmediato. El ruido dolía y se difundió cual rumor en las calles para luego dar paso a la nada, al vacío.    ",
  ...
  {
    text: "“Tenía una mujer hermosa y unos hijos maravillosos. Eran lo más lindo que me pudo dar la vida”, señala el portovejense, mientras dibuja una sonrisa y reflexiona que hay personas que les hubiera gustado tener una familia como la que él tenía.  ",
  ...
  {
    text: "Y es que es tan difícil preguntar sobre la pérdida de sus seres queridos a pocos metros de distancia de donde ocurrió todo. Pero Javier no tiene problema en contar que, 10 años después, aquella esquina luce diferente.  ",
  ...
  {
    text: "El edificio de seis pisos que aplastó a su familia ya no está; solo queda el espacio cercado por una reja negra conteniendo el césped crecido; en total calma. Tampoco está aquella escena apocalíptica que vio mientras buscaba a su familia.  ",
    img: pickImage(chronicle2HorizontalImages, 4),
    mobileImg: pickImage(chronicle2HorizontalMobileImages, 4),
  },
  {
    text: "Marcó el número del celular de su esposa y no tuvo respuesta. También llamó a su suegra y cuñadas. Nada funcionaba. Insistía. No podía hacer otra cosa, porque tenía la esperanza de encontrarlos con vida. ",
  ...
  {
    text: "“Vicky”, gritaba repetidamente y ella no contestaba. Pensaba que tal vez su esposa tocaría el claxon y él llegaría a rescatarlos.\n\n Los minutos pasaban y dibujaba mapas en su mente para seguir el rastro del vehículo por las calles de Portoviejo. Pero sus esfuerzos no dieron frutos.  ",
    img: pickImage(chronicle2HorizontalImages, 6),
    mobileImg: pickImage(chronicle2HorizontalMobileImages, 6),
  },
  {
    text: "Al siguiente día los encontró. El carro con su esposa, dos de sus tres hijos, su suegra, sus cuñadas y su sobrino yacían debajo de los desechos de lo que fue el edificio del Seguro Social. ",
