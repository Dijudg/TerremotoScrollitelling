      ...
      <div className="container relative z-10 mx-auto max-w-4xl px-6">
        <SectionReveal>
          ...
          <div className="space-y-9 text-lg leading-relaxed text-gray-200 md:text-xl">
            <p>
Pablo tenía razón al sentirse incómodo. <strong>A las 18:58, un fuerte terremoto azotó Manabí y devastó Pedernales -epicentro del sismo-, Manta y Portoviejo, ciudad natal de Pablo.</strong>             </p>

            <p>
El movimiento fue tan intenso que edificaciones como el hotel ‘El Gato’ se vinieron abajo con un estruendo ensordecedor. Las paredes y las columnas parecían hechas con arena; simplemente se desplomaron, dejando las losas apiladas al igual que un ‘pancake’.             </p>

            <p>
Cientos de personas fallecieron entre los escombros. Según cifras oficiales del gobierno de ese entonces, <strong>672 personas perecieron</strong>. Pero hubo otras tantas que quedaron sepultadas a la espera de que alguien los salvara.             </p>
          </div>
        </SectionReveal>
      </div>
