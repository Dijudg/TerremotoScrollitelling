      ...
      <motion.div className="container mx-auto relative z-10 max-w-4xl px-6 " style={{ opacity }}>
        <SectionReveal>
          ...
          <div className="space-y-10 text-lg leading-relaxed text-gray-200 md:text-xl">
            <p>
La tarde del domingo 17 de abril, Pablo concilió el sueño. Cientos de pensamientos rondaban su cabeza y había uno central: ¿Lo encontrarían con vida?
            </p>
            <p>
Así amaneció el lunes 18 y este portovejense, de 63 años -a quien le dicen un ‘traga años’ porque parece más joven-, despertó sin energías y la esperanza empezó a flaquear. La voz se le apagó y, por primera vez, pensó en la muerte.
            </p>  
            </div>
        </SectionReveal>
...
Cansado, tomó su celular y revisó los últimos números que estaban en la memoria del dispositivo. “Doña Verónica”, decía uno de ellos. Se trataba de una esmeraldeña a la que Pablo le estaba construyendo un anaquel. Días atrás y como el mueble era muy alto, le faltaron clavos y le llamó para que le comprara algunos. 
            ...
            >
              Sin pensarlo dos veces, aplastó el botón de llamar y al otro lado de la línea una voz contestó: 
              <motion.div
              ...
              <span className="block w-full md:px-16 text-center text-lg font-light italic md:-mt-8"> , dijo la mujer entre risas y con aquella exuberancia típica del dialecto de la Costa de Ecuador.   </span>
...
Esa voz femenina lo trajo a la vida. “Doña Verónica, estoy atrapado en el hotel y los escombros me van a matar”, gritó con esperanza.
             ...
             <p>
Verónica llamó de inmediato a los cuerpos de rescate. En menos de 10 minutos se escuchó el timbre del teléfono de Pablo. Venían en camino para sacarlo. 
            </p>
            </div> 
        </SectionReveal>
        ...
        <div className="mt-24">
          <SectionReveal>
            ...
            <div className="space-y-8 text-lg leading-relaxed text-gray-300 md:text-xl">
              <p>
Los cuerpos de rescate se dirigieron rápidamente hacia donde él estaba. Ya no era el hotel donde laboró durante 18 años. Solo quedaba un cúmulo de fierros torcidos y paredes destruidas de lo que había sido su segundo hogar. 
              </p>
              <p className="text-white">
“Recibí una llamada del ECU, era una voz de un colombiano. Les dije: soy Pablo Córdoba y estoy completamente sano, por favor, quiero que me rescaten”, contó. Con su voz recortada, él  aún siente la alegría y la esperanza que le provocó aquella conversación. 
              </p>
              <p>
Le preguntaron dónde estaba y él les dio la ubicación exacta. “Estoy a unos 30 metros de la entrada del hotel, entre las calles Pedro Gual y Olmedo”. 
              </p> 
              </div>
          </SectionReveal>
        </div>
