...
const fantasmaMarketGalleryCaptions = [
  "Centro comercial Nuevo Tarqui, uno de los espacios creados para reubicar a los comerciantes afectados por el terremoto.",
  ...
  "John Vera dentro de su local, donde vende, organiza y sigue apostando por la reactivación de Tarqui.",
  ...
  "Otra estructura afectada en Manta, con grietas y deterioro que dejaron expuesta la magnitud del sismo.",
  "Edificio con deterioro estructural en Manta, una de las huellas que aún permanecen tras el terremoto.",
 "Vista general del memorial de Manta, convertido en un punto de encuentro para la memoria del terremoto.",
